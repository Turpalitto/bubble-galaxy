 ...
 *
 * Глава 10 «Всё сразу» (позиции 117–130) — финальный блок после финального
 * босса главы 9: лёд, куры и held-кнопка встречаются в ней поодиночке, попарно
 * и все вместе сразу (финал 130 — капстоун трёх механик). Уровни собраны из
 ...
 */
const CHAPTER_SIZES: number[] = [12, 12, 12, 12, 12, 16, 12, 16, 12, 14];
